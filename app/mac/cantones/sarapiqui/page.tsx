...
export default function SarapiquiPage() {
    return (
            ...
            <main className="flex-1">
                    ...
                    <div className="container mx-auto max-w-6xl relative">
                        ...
                        >
                            ...
                            <Badge className="bg-white text-[#B11D1D] font-bold shadow-md mb-4">
                                Código Postal {sarapiquiMAC.codigoPostal}
                            </Badge>
                        </motion.div>
                    </div>
                </section>
                ...
                <section className="py-20 px-6 lg:px-12 bg-gradient-to-b from-white to-gray-50">
                    <div className="container mx-auto max-w-6xl space-y-12">
                        {sarapiquiMAC.secciones.map((seccion, index) => (
                            <motion.div
                                key={seccion.id}
                                initial={{ opacity: 0, y: 20 }}
                                    ...
                                    <CardContent className="p-8 lg:p-10 space-y-6">
                                        <div className="flex items-center gap-4">
                                            <div className="p-3 rounded-lg bg-[#B11D1D]/10">
                                                {seccion.id === "perfil-general" && <MapPinned className="h-6 w-6 text-[#B11D1D]" />}
                                                {seccion.id === "crecimiento-demografico" && <BarChart3 className="h-6 w-6 text-[#B11D1D]" />}
                                                {seccion.id === "estructura-etaria" && <Users className="h-6 w-6 text-[#B11D1D]" />}
                                                {seccion.id === "genero-composicion" && <Info className="h-6 w-6 text-[#B11D1D]" />}
                                            </div>
                                                        ...
                                                        <thead className="bg-[#852C2C]/5">
                                                            <tr>
                                                                {tabla.columnas.map((col) => (
                                                                    <th key={col} className="px-4 py-2 text-left font-semibold text-[#332222]">
                                                                        {col}
                                                                    </th>
                                                                ))}
                                                            </tr>
                                                        ...
                                                        <tbody>
                                                            {tabla.filas.map((fila, f) => (
                                                                <tr key={f} className="border-t">
                                                                    {fila.map((celda, c) => (
                                                                        <td key={c} className="px-4 py-2 text-[#332929]/80">
                                                                            {celda}
                                                                        </td>
                                                                    ))}
                                                                </tr>
                            ...
                            <Card className="border border-[#852C2C]/10 hover:shadow-2xl transition-all duration-300 bg-white">
                                <CardContent className="p-8 lg:p-10 space-y-6">
                                    ...
                                    <div className="text-[#332929]/80 leading-relaxed">
                                        <p className="mb-6">
                                            El Instituto de Desarrollo Rural (INDER) ha elaborado documentos técnicos y de planificación para el cantón de Sarapiquí.
                                            A continuación, puede descargar los documentos oficiales disponibles:
                                        </p>

                                        <div className="grid gap-4 md:grid-cols-2">
                                            <a
                                                href="https://wyrrwfllwtocyrcmllem.supabase.co/storage/v1/object/public/documentos-proyectos/Sarapiqui/PDRT-Sarapiqui-Heredia-Sarapiqui-Alajuela.pdf"
                                                target="_blank"
                                            ...
                                            <a
                                                href="https://wyrrwfllwtocyrcmllem.supabase.co/storage/v1/object/public/documentos-proyectos/Sarapiqui/Caracterizacion-Territorio-Sarapiqui.pdf"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center gap-3 p-4 rounded-lg border border-[#852C2C]/20 hover:border-[#B11D1D] hover:bg-[#B11D1D]/5 transition-all duration-300 group"
                                            >
                                            ...
                                            <a
                                                href="https://wyrrwfllwtocyrcmllem.supabase.co/storage/v1/object/public/documentos-proyectos/Sarapiqui/Boletin-Sarapiqui.pdf"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center gap-3 p-4 rounded-lg border border-[#852C2C]/20 hover:border-[#B11D1D] hover:bg-[#B11D1D]/5 transition-all duration-300 group"
                                            >
                                            ...
                                            <a
                                                href="https://wyrrwfllwtocyrcmllem.supabase.co/storage/v1/object/public/documentos-proyectos/Sarapiqui/mapa-territorio-sarapiqui.jpg"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center gap-3 p-4 rounded-lg border border-[#852C2C]/20 hover:border-[#B11D1D] hover:bg-[#B11D1D]/5 transition-all duration-300 group"
                                            >
                        ...
                        <Card className="border border-[#852C2C]/10 bg-gradient-to-br from-[#852C2C]/5 to-[#B11D1D]/5">
                            <CardContent className="p-8 space-y-3">
                                ...
                                {sarapiquiMAC.notas.map((nota, i) => (
                                    <p key={i} className="text-sm text-[#332929]/80">
                                        • {nota}
                                    </p>
                                ))}
                            </CardContent>
